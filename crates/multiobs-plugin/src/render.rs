...
fn icon_path(kind: ActionKind) -> &'static str {
    match kind {
        ...
        ActionKind::VirtualCam => {
            r#"<rect x="10" y="18" width="30" height="24" rx="4"/><path d="M40 26l14-6v24l-14-6"/>"#
        }
        ActionKind::StudioMode => {
            r#"<rect x="8" y="16" width="20" height="28"/><rect x="36" y="16" width="20" height="28"/>"#
        }
        ...
        ActionKind::Source => {
            r#"<rect x="12" y="16" width="18" height="18"/><rect x="34" y="30" width="18" height="18"/>"#
        }
        ...
        ActionKind::Collection => {
            r#"<rect x="12" y="18" width="28" height="28"/><path d="M24 18V12h28v28h-6"/>"#
        }
        ActionKind::Profile => {
            r#"<circle cx="32" cy="24" r="10"/><path d="M14 50c2-12 12-16 18-16s16 4 18 16"/>"#
        }
        ActionKind::Screenshot => {
            r#"<rect x="12" y="20" width="40" height="28" rx="4"/><circle cx="32" cy="34" r="6"/>"#
        }
        ActionKind::Hotkey => {
            r#"<rect x="10" y="22" width="44" height="22" rx="4"/><path d="M20 28v8M32 28v8M44 28v8"/>"#
        }
...
mod tests {
    ...
    #[test]
    fn mixed_preview_does_not_turn_the_key_on() {
        assert_eq!(
            hardware_state([SegmentState::Active, SegmentState::Intermediate]),
            1
        );
        assert_eq!(
    ...
    fn draws_one_segment_per_instance() {
        ...
        let svg = String::from_utf8(
            STANDARD
                .decode(image.trim_start_matches("data:image/svg+xml;base64,"))
                .unwrap(),
        )
        .unwrap();
